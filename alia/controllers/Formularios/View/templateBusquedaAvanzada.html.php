...
echo "<form class=\"una-columna\" enctype=\"multipart/form-data\" method=\"post\" id=\"form_".$datos['controller']."_".$datos['name']."\" action=\"". getUrl()."/admin/\" $eventos>";
...
echo "<input type=\"hidden\" class=\"controller\" name=\"ajax\" value=\"true\" />";
echo "<input type=\"submit\" name=\"submit\" class=\"submit\" value=\"Aceptar\" />";
echo "<input type=\"reset\" name=\"reset\" class=\"submit\" value=\"Deshacer\" />";
echo "</form>";