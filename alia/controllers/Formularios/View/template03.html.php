...
echo "<form class=\"tres-columnas\" enctype=\"multipart/form-data\" method=\"post\" id=\"form_".$datos['controller']."_".$datos['name']."\" action=\"". getUrl()."/admin/\" $eventos>";
$i=0;
foreach($campos as $campo){
    $eventos=(isset($campo['eventos']) && count($campo['eventos'])>0)?" ".implode(" ",$campo['eventos']):"";
    if($i%3==0) echo "<div class=\"linea\">"; 
